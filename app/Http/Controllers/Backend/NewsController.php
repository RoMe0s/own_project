...
use App\Traits\Controllers\ProccessCategoriesTrait;
use Datatables;
use DB;
use Event;
use Exception;
...
class NewsController extends BackendController
{
    ...
    {
        $input = $this->proccessWithCategories($request->all());
    ...
    {
        $this->data('tags_array', $this->getTagsList());

        $this->data('selected_tags', $this->getSelectedTagsList($model));

        $this->data('categories_array', ['' => trans('labels.no') ] + $this->getAdminCategoriesList());
    }
}