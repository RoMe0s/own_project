@include('news.partials._buttons', ['class' => 'buttons-top'])
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li>
                    ...
                    <li>
                        <a aria-expanded="false" href="#categories" data-toggle="tab">@lang('labels.tab_categories')</a>
                    </li>
...
@include('news.partials._buttons')