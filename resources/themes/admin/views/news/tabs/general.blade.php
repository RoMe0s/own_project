...
<div class="form-group @if ($errors->has('publish_at')) has-error @endif">
    ...
    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
        <div class="input-group">
            {!! Form::text('publish_at', (isset($model->publish_at)) ? null : \Carbon\Carbon::now()->format('d-m-Y'), ['placeholder' => trans('labels.publish_at'), 'class' => 'form-control input-sm inputmask-birthday datepicker-birthday']) !!}
